...
// TEMPLATES DATA
// ============================================
// This is the list of all quiz categories shown on the dashboard.
// Each template has:
//   - name: Display name of the quiz
//   - desc: Short description shown on the card
//   - icon: URL to an icon image (from Flaticon CDN)
//   - slug: URL-friendly identifier (used in routes like /quiz/science-trivia)
//   - aiPrompt: The prompt sent to Gemini AI to generate questions
